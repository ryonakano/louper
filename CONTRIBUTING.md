...
1. [Search for existing issues](https://github.com/ryonakano/louper/issues) to check if it's a known issue.
2. [Create a new issue](https://github.com/ryonakano/louper/issues/new) if it's not reported yet.
